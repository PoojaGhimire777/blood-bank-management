...
public class UserController {
    ...
    public ResponseEntity<HttpStatus> authenticateUser(@RequestParam String username,@RequestParam String password,@RequestParam String role) {
    	HttpStatus status = userService.validateUser( username,  password,  role);
